...
for (let name in components) {
  ...
  fs.writeFileSync(docPath, `<!-- generated by doc script, do not edit -->\n\n# ${name}\n\n` + content);
  fs.writeFileSync(renderPath, `<template><!-- generated by doc script, do not edit -->${renderMarkdown(content)}</template>`);
}
