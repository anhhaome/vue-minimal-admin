export default {
  fontSize: {
    ...
    '3xl': ['1.375rem', { lineHeight: '1.875rem' }],
    '4xl': ['1.5rem', { lineHeight: '2rem' }],
    '5xl': ['1.625rem', { lineHeight: '1' }],
    '6xl': ['1.75rem', { lineHeight: '1' }],
    '7xl': ['1.875rem', { lineHeight: '1' }],
    '8xl': ['2rem', { lineHeight: '1' }],
    '9xl': ['2.125rem', { lineHeight: '1' }]
  },
  spacing: {
    px: '1px',
    0: '0px',
